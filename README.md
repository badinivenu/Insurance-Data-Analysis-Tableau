...
- Study **policyholder demographics** (Age & Gender)
- Compare **claim amounts by policy type**
- Identify **monthly policy trends**
...
- **Total Claim Amount:** ₹16,904,295  
- **Average Claim Amount:** ₹1,690  
...
- Donut chart used for clear visualization
...
- Claim status divided into:
  ...
  - **Pending**
  - **Settled**
- Majority of policies fall under **Not Claimed**
- Provides insight into claim processing efficiency
...
- Age groups analyzed:
  ...
  - 46–65
  - 66+
- Most policyholders belong to the **26–65 age group**

#### Gender Distribution
- Equal distribution of policies:
  - **Male:** 5,000  
  - **Female:** 5,000  
...
These filters allow users to dynamically explore and customize insights.
...
- Effective **data storytelling using visual analytics**
...
- Connect with real-time insurance datasets
